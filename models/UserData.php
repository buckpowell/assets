...
class UserData extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'accounts_receivable_good' => 'Accounts Receivable Good',
            'assets_conv_to_cash' => 'Assets Conv To Cash',
            'total_current_assets' => 'Total Current Assets',
            'real_estate' => 'Real Estate',
            'mortages_owned' => 'Mortages Owned',
            'accounts_receivable_doubt' => 'Accounts Receivable Doubt',
            'notes_relatives_friends' => 'Notes Relatives Friends',
            'other_securities_not_marketable' => 'Other Securities Not Marketable',
